      ...
      <div className="max-w-9xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-2.5 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden md:flex space-x-10">
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      "group bg-white rounded-md inline-flex items-center text-sm md:text-base font-medium hover:text-gray-900"
                    )}
                  >
                    <span>Features</span>
                    <ChevronDownIcon
            ...
            <a
              href="#"
              className="text-sm md:text-base font-medium text-gray-500 hover:text-gray-900"
            >
              Docs
            </a>
